...
public class CustomsWarehouseRule : IRule
{
    ...
    public void Invoke(SpsCertificate spsCertificate, IList<ValidationError> validationErrors)
    {
        ...
        {
            validationErrors.Add(new ValidationError(RuleErrorMessage.RegisteredNumberMissingCustomsWarehouseNumber, RuleErrorId.RegisteredNumberMissingCustomsWarehouseNumber));
        }
    }
}
