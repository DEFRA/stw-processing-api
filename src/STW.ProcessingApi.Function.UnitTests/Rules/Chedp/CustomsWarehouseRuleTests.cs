...
public class CustomsWarehouseRuleTests
{
    ...
    [TestMethod]
    public void ShouldInvoke_ReturnsTrue_WhenChedTypeIsChedpPurposeConformingGoodsAndDestinationTypeCustomsWarehouse()
    {
        // Arrange
        var spsCertificate = new SpsCertificate
        {
            SpsExchangedDocument = new SpsExchangedDocument
            {
                ...
                IncludedSpsNote = new List<SpsNoteType>
                {
                    ...
                    SpsCertificateTestHelper.BuildSpsNoteTypeWithSubjectCodeAndContent(SubjectCode.NonConformingGoodsDestinationType, DestinationType.CustomsWarehouse)
                }
            }
        };
    ...
    public void ShouldInvoke_ReturnsFalse_WhenChedTypeNotChedpPurposeNotConformingGoodsAndDestinationTypeNotCustomsWarehouse(string chedType, string purpose, string destinationType)
    {
        // Arrange
        var spsCertificate = new SpsCertificate
        {
